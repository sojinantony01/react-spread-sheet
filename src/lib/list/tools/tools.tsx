    ...
    <div className="sheet-tools-container">
      <div className="sheet-tools">
        ...
        <div className="sheet-tools-text-cell-color-container">
          <button onClick={()=> fontColorRef.current?.click()}>A <span className="sheet-color-strip" style={{backgroundColor: selectedStyles['color']}}></span></button>
          <input
            ref={fontColorRef}
            type="color"
        ...
        <div className="sheet-tools-text-align-container">
            <button className={selectedStyles["textAlign"] === "left" ? "text-style-btn-active" : ""} data-testid="align-left" onClick={() => changeStyle("ALIGN-LEFT")}>
              <Icons type="align-left" />
            </button>
            <button className={selectedStyles["textAlign"] === "center" ? "text-style-btn-active" : ""} data-testid="align-center" onClick={() => changeStyle("ALIGN-CENTER")}>
              <Icons type="align-center" />
            </button>
            <button className={selectedStyles["textAlign"] === "right" ? "text-style-btn-active" : ""} data-testid="align-right" onClick={() => changeStyle("ALIGN-RIGHT")}>
              <Icons type="align-right" />
            </button>
            <button className={selectedStyles["textAlign"] === "justify" ? "text-style-btn-active" : ""} data-testid="align-justify" onClick={() => changeStyle("ALIGN-JUSTIFY")}>
